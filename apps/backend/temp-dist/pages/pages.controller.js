...
var PagesController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('public', 'admin'), (0, common_1.Controller)('pages')];
    ...
    var PagesController = _classThis = /** @class */ (function () {
        function PagesController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        PagesController_1.prototype.findBySlug = function (slug) {
            return this.service.findBySlug(slug);
        };
        PagesController_1.prototype.findAll = function () {
            return this.service.findAll();
        };
        PagesController_1.prototype.create = function (dto) {
            return this.service.create(dto);
        };
        PagesController_1.prototype.update = function (id, dto) {
            return this.service.update(id, dto);
        };
        PagesController_1.prototype.remove = function (id) {
            return this.service.delete(id);
        };
        return PagesController_1;
    }());
    __setFunctionName(_classThis, "PagesController");
    (function () {
