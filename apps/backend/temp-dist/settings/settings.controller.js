...
var SettingsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('admin', 'public'), (0, common_1.Controller)('settings')];
    ...
    var SettingsController = _classThis = /** @class */ (function () {
        ...
        SettingsController_1.prototype.get = function () {
            return this.settingsService.get();
        };
        SettingsController_1.prototype.update = function (updateDto) {
    ...
    (function () {
        ...
        _get_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Get settings (public)' })];
        _update_decorators = [(0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard, rbac_guard_1.RbacGuard), (0, common_1.Patch)(), (0, permissions_decorator_1.RequirePermissions)('settings.write'), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Update settings' })];
