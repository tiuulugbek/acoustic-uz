...
var AuthService = function () {
    ...
    var AuthService = _classThis = /** @class */ (function () {
        ...
        AuthService_1.prototype.login = function (loginDto) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, email, password, user, payload, accessToken, refreshToken;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = shared_1.loginSchema.parse(loginDto), email = _a.email, password = _a.password;
        ...
        AuthService_1.prototype.changePassword = function (userId, changePasswordDto) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, currentPassword, newPassword, user, isPasswordValid, hashedPassword;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            _a = shared_1.changePasswordSchema.parse(changePasswordDto), currentPassword = _a.currentPassword, newPassword = _a.newPassword;
        ...
        AuthService_1.prototype.refreshToken = function (refreshToken) {
            return __awaiter(this, void 0, void 0, function () {
                var payload, user, newPayload, accessToken, error_1;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
