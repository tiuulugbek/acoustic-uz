...
var SearchService = function () {
    ...
    var SearchService = _classThis = /** @class */ (function () {
        ...
        SearchService_1.prototype.search = function (q) {
            return __awaiter(this, void 0, void 0, function () {
                var query, _a, products, services, posts;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0:
                            query = q.trim();
                            if (!query) {
                                return [2 /*return*/, { products: [], services: [], posts: [] }];
                            }
                        ...
                        case 1:
                            _a = _b.sent(), products = _a[0], services = _a[1], posts = _a[2];
                            return [2 /*return*/, { products: products, services: services, posts: posts }];
                    }
                });
            });
        };
