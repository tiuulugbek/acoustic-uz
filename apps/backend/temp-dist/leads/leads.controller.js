...
var LeadsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('public', 'admin'), (0, common_1.Controller)('leads')];
    ...
    var LeadsController = _classThis = /** @class */ (function () {
        ...
        LeadsController_1.prototype.create = function (createDto) {
            return this.leadsService.create(createDto);
        };
        LeadsController_1.prototype.findAll = function () {
            return this.leadsService.findAll();
        };
        LeadsController_1.prototype.findOne = function (id) {
            return this.leadsService.findOne(id);
        };
        LeadsController_1.prototype.update = function (id, updateDto) {
            return this.leadsService.update(id, updateDto);
        };
        LeadsController_1.prototype.remove = function (id) {
