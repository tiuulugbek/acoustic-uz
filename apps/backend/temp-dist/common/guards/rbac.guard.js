...
var RbacGuard = function () {
    ...
    var RbacGuard = _classThis = /** @class */ (function () {
        function RbacGuard_1(reflector, prisma) {
            this.reflector = reflector;
            this.prisma = prisma;
        }
        RbacGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var requiredPermissions, request, user, role;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            requiredPermissions = this.reflector.getAllAndOverride('permissions', [
                                context.getHandler(),
                                context.getClass(),
                            ]);
                        ...
                        case 1:
                            ...
                            return [2 /*return*/, requiredPermissions.every(function (permission) {
                                    ...
                                    return role.permissions.some(function (userPermission) {
                                        if (userPermission === '*')
                                            return true;
                                        if (userPermission === permission)
                                            return true;
                                        if (userPermission.endsWith('.*')) {
                                            var prefix = userPermission.slice(0, -2);
