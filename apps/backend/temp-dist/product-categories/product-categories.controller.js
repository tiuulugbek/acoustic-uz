...
var ProductCategoriesController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('public', 'admin'), (0, common_1.Controller)('product-categories')];
    ...
    var ProductCategoriesController = _classThis = /** @class */ (function () {
        function ProductCategoriesController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        ProductCategoriesController_1.prototype.findAll = function () {
            return this.service.findAll();
        };
        ProductCategoriesController_1.prototype.create = function (dto) {
            return this.service.create(dto);
        };
        ProductCategoriesController_1.prototype.update = function (id, dto) {
            return this.service.update(id, dto);
        };
        ProductCategoriesController_1.prototype.remove = function (id) {
            return this.service.delete(id);
        };
        return ProductCategoriesController_1;
    }());
    __setFunctionName(_classThis, "ProductCategoriesController");
    (function () {
        ...
        ProductCategoriesController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return ProductCategoriesController = _classThis;
}();
