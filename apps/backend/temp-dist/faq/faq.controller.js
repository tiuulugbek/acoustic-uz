...
var FaqController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('public', 'admin'), (0, common_1.Controller)('faq')];
    ...
    var FaqController = _classThis = /** @class */ (function () {
        function FaqController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        FaqController_1.prototype.findAll = function (publicOnly) {
            return this.service.findAll(publicOnly === 'true');
        };
        FaqController_1.prototype.create = function (dto) {
            return this.service.create(dto);
        };
        FaqController_1.prototype.update = function (id, dto) {
            return this.service.update(id, dto);
        };
        FaqController_1.prototype.remove = function (id) {
            return this.service.delete(id);
        };
        return FaqController_1;
    }());
    __setFunctionName(_classThis, "FaqController");
    (function () {
        ...
        FaqController = _classThis = _classDescriptor.value;
        if (_metadata) Object.defineProperty(_classThis, Symbol.metadata, { enumerable: true, configurable: true, writable: true, value: _metadata });
        __runInitializers(_classThis, _classExtraInitializers);
    })();
    return FaqController = _classThis;
}();
