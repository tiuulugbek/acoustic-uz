...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, logger, corsOrigins, config, document, port;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    corsOrigins = configService.get('CORS_ORIGIN', '').split(',');
                    app.enableCors({
                ...
                case 2:
                    ...
                    logger.log("\uD83D\uDCDA Swagger documentation: http://localhost:".concat(port, "/api/docs"));
                    return [2 /*return*/];
            }
        });
    });
