...
var ServicesController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('public', 'admin'), (0, common_1.Controller)('services')];
    ...
    var ServicesController = _classThis = /** @class */ (function () {
        ...
        ServicesController_1.prototype.findAll = function (publicOnly) {
            return this.servicesService.findAll(publicOnly === 'true');
        };
        ServicesController_1.prototype.findBySlug = function (slug) {
            return this.servicesService.findBySlug(slug);
        };
        ServicesController_1.prototype.findAllAdmin = function () {
            return this.servicesService.findAll(false);
        };
        ServicesController_1.prototype.findOne = function (id) {
            return this.servicesService.findOne(id);
        };
        ServicesController_1.prototype.create = function (createDto) {
            return this.servicesService.create(createDto);
        };
        ServicesController_1.prototype.update = function (id, updateDto) {
