...
var ServicesService = function () {
    ...
    var ServicesService = _classThis = /** @class */ (function () {
        ...
        ServicesService_1.prototype.findBySlug = function (slug) {
            return __awaiter(this, void 0, void 0, function () {
                var service;
                return __generator(this, function (_a) {
                    switch (_a.label) {
        ...
        ServicesService_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                var validated;
                var _a;
                return __generator(this, function (_b) {
                    validated = shared_1.serviceSchema.parse(data);
                    return [2 /*return*/, this.prisma.service.create({
                            data: __assign(__assign({}, validated), { coverId: (_a = validated.coverId) !== null && _a !== void 0 ? _a : undefined }),
                            include: { cover: true },
                        })];
                });
            });
        };
        ServicesService_1.prototype.update = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                var validated, updateData;
                return __generator(this, function (_a) {
                    validated = shared_1.serviceSchema.partial().parse(data);
                    updateData = __assign(__assign({}, validated), (validated.coverId !== undefined ? { coverId: validated.coverId } : {}));
        ...
        ServicesService_1.prototype.delete = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.service.delete({
                            where: { id: id },
                        })];
                });
            });
