...
var RolesService = function () {
    ...
    var RolesService = _classThis = /** @class */ (function () {
        ...
        RolesService_1.prototype.create = function (data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        RolesService_1.prototype.update = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.role.update({
                            where: { id: id },
                            data: data,
                        })];
                });
        ...
        RolesService_1.prototype.delete = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.role.delete({
                            where: { id: id },
                        })];
                });
            });
