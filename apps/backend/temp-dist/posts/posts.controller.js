...
var PostsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('public', 'admin'), (0, common_1.Controller)('posts')];
    ...
    var PostsController = _classThis = /** @class */ (function () {
        function PostsController_1(service) {
            this.service = (__runInitializers(this, _instanceExtraInitializers), service);
        }
        PostsController_1.prototype.findAll = function (publicOnly) {
            return this.service.findAll(publicOnly === 'true');
        };
        PostsController_1.prototype.findBySlug = function (slug) {
            return this.service.findBySlug(slug);
        };
        PostsController_1.prototype.create = function (dto) {
            return this.service.create(dto);
        };
        PostsController_1.prototype.update = function (id, dto) {
