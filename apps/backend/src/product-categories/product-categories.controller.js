...
let ProductCategoriesController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('public', 'admin'), (0, common_1.Controller)('product-categories')];
    ...
    var ProductCategoriesController = class {
