...
exports.LocaleCacheInterceptor = void 0;
 ...
 */
let LocaleCacheInterceptor = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var LocaleCacheInterceptor = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            LocaleCacheInterceptor = _classThis = _classDescriptor.value;
            ...
            if (isPublic) {
                ...
                if (existingVary) {
                    ...
                    const existingHeaders = Array.isArray(existingVary)
                        ? existingVary
                        : existingVary.toString().split(',').map((h) => h.trim());
    ...
    return LocaleCacheInterceptor = _classThis;
})();
exports.LocaleCacheInterceptor = LocaleCacheInterceptor;
//# sourceMappingURL=locale-cache.interceptor.js.map