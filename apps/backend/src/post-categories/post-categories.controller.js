...
exports.PostCategoriesController = void 0;
...
let PostCategoriesController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('public', 'admin'), (0, common_1.Controller)('post-categories')];
    ...
    var PostCategoriesController = class {
        ...
        static {
            ...
            PostCategoriesController = _classThis = _classDescriptor.value;
    ...
    return PostCategoriesController = _classThis;
})();
exports.PostCategoriesController = PostCategoriesController;
//# sourceMappingURL=post-categories.controller.js.map