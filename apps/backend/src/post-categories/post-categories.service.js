...
exports.PostCategoriesService = void 0;
const common_1 = require("@nestjs/common");
let PostCategoriesService = (() => {
    let _classDecorators = [(0, common_1.Injectable)()];
    let _classDescriptor;
    let _classExtraInitializers = [];
    let _classThis;
    var PostCategoriesService = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            __esDecorate(null, _classDescriptor = { value: _classThis }, _classDecorators, { kind: "class", name: _classThis.name, metadata: _metadata }, null, _classExtraInitializers);
            PostCategoriesService = _classThis = _classDescriptor.value;
    ...
    return PostCategoriesService = _classThis;
})();
exports.PostCategoriesService = PostCategoriesService;
//# sourceMappingURL=post-categories.service.js.map