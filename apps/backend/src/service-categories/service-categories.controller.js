...
let ServiceCategoriesController = (() => {
    let _classDecorators = [(0, swagger_1.ApiTags)('public', 'admin'), (0, common_1.Controller)('service-categories')];
    ...
    var ServiceCategoriesController = class {
        static { _classThis = this; }
        static {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _findAll_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Get all service categories (public)' })];
            _findBySlug_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)('slug/:slug'), (0, swagger_1.ApiOperation)({ summary: 'Get service category by slug (public)' })];
            ...
            ServiceCategoriesController = _classThis = _classDescriptor.value;
        ...
        findAll(publicOnly, limit, offset) {
    ...
    return ServiceCategoriesController = _classThis;
})();
