 ...
 */
function useTooltipManager(containerRef) {
    const tooltipRefsRef = (0, react_1.useRef)(new Map());
    (0, react_1.useEffect)(() => {
        ...
        const handleMouseEnter = (e) => {
            ...
            if (trigger.isConnected) {
                trigger.classList.add('tooltip-trigger', 'cursor-help', 'border-b', 'border-dashed', 'border-brand-primary', 'text-brand-primary');
            }
      ...
      `;
        ...
        const ensureClasses = () => {
            const triggers = Array.from(container.querySelectorAll('.tooltip-trigger'));
