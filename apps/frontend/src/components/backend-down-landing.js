...
exports.default = BackendDownLanding;
...
function BackendDownLanding() {
    const [locale, setLocale] = (0, react_1.useState)(getLocaleFromDOM());
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-brand-primary/5 via-background to-brand-accent/5">
      ...
      <div className="relative mx-auto max-w-5xl px-4 py-12 md:py-20 md:px-6">
        ...
        <div className="mb-8 rounded-xl border-2 border-amber-200 bg-amber-50/80 backdrop-blur-sm p-4 shadow-sm">
          <div className="flex items-center justify-center gap-3">
            <lucide_react_1.AlertCircle className="h-5 w-5 text-amber-600 animate-pulse"/>
        ...
        <div className="mb-10 rounded-3xl border border-border/50 bg-card/80 backdrop-blur-xl shadow-2xl">
          <div className="p-8 md:p-14">
            ...
            <div className="grid gap-6 md:grid-cols-3 md:gap-8">
              {/* Phone */}
              <a href={`tel:${info.phone.replace(/\s/g, '')}`} className="group relative overflow-hidden rounded-2xl border-2 border-brand-primary/20 bg-gradient-to-br from-brand-primary/5 to-transparent p-6 text-center transition-all hover:border-brand-primary hover:shadow-lg hover:scale-105">
                <div className="mb-4 flex justify-center">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-brand-primary/20 to-brand-primary/10 transition-transform group-hover:scale-110">
                    <lucide_react_1.Phone className="h-7 w-7 text-brand-primary"/>
                  </div>
                </div>
              ...
              {/* Email */}
              <a href={`mailto:${info.email}`} className="group relative overflow-hidden rounded-2xl border-2 border-brand-primary/20 bg-gradient-to-br from-brand-primary/5 to-transparent p-6 text-center transition-all hover:border-brand-primary hover:shadow-lg hover:scale-105">
                <div className="mb-4 flex justify-center">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-brand-primary/20 to-brand-primary/10 transition-transform group-hover:scale-110">
                    <lucide_react_1.Mail className="h-7 w-7 text-brand-primary"/>
                  </div>
                </div>
                <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-muted-foreground">
              ...
              <div className="group rounded-2xl border-2 border-brand-primary/20 bg-gradient-to-br from-brand-primary/5 to-transparent p-6 text-center transition-all hover:border-brand-primary hover:shadow-lg">
                <div className="mb-4 flex justify-center">
                  <div className="flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-brand-primary/20 to-brand-primary/10 transition-transform group-hover:scale-110">
                    <lucide_react_1.MapPin className="h-7 w-7 text-brand-primary"/>
                  </div>
                </div>
                <p className="mb-2 text-sm font-semibold uppercase tracking-wide text-muted-foreground">
        ...
        <div className="mb-8 text-center">
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            return (<a key={social.name} href={social.href} target="_blank" rel="noopener noreferrer" className={`group flex h-16 w-16 items-center justify-center rounded-2xl border-2 border-border bg-card shadow-md transition-all hover:scale-110 hover:shadow-xl ${social.color}`} aria-label={social.name} title={social.name}>
        ...
        <div className="text-center">
          <div className="inline-flex items-center gap-3 rounded-full border-2 border-border bg-card px-8 py-4 shadow-md">
        ...
        }} className={`rounded-full px-5 py-2 text-sm font-semibold transition-all ${locale === 'uz'
            ...
            window.location.href = apiUrl;
        }} className={`rounded-full px-5 py-2 text-sm font-semibold transition-all ${locale === 'ru'
            ? 'bg-brand-primary text-white shadow-md'
            : 'text-muted-foreground hover:bg-muted hover:text-brand-primary'}`}>
              RU
            </button>
...
//# sourceMappingURL=backend-down-landing.js.map