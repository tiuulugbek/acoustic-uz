...
exports.default = TestIntro;
const lucide_react_1 = require("lucide-react");
function TestIntro({ locale, onContinue }) {
    ...
    return (<div className="space-y-10 max-w-3xl mx-auto">
      ...
      <div className="flex justify-center">
        <button onClick={onContinue} className="px-8 py-3 bg-brand-primary text-white rounded-lg font-semibold text-lg hover:bg-brand-primary/90 transition-colors shadow-lg">
          {isRu ? 'Продолжить' : 'Davom etish'}
        </button>
      </div>
    </div>);
}
//# sourceMappingURL=test-intro.js.map