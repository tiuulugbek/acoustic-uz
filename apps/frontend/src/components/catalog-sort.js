...
function CatalogSort({ categorySlug, locale, currentSort }) {
    ...
    return (<div className="flex items-center gap-3">
      ...
      <select id="sort" value={currentSort} onChange={(e) => handleSortChange(e.target.value)} className="rounded-lg border border-border/60 bg-white px-3 py-2 text-sm focus:border-brand-primary focus:outline-none focus:ring-2 focus:ring-brand-primary/40">
...
//# sourceMappingURL=catalog-sort.js.map