...
async function GET(request) {
    ...
    response.cookies.set(locale_1.LOCALE_COOKIE_NAME, 'uz', {
        path: '/',
    ...
    // Log for debugging
    if (process.env.NODE_ENV === 'development') {
        console.log(`[Locale Route /uz] ✅ Setting cookie ${locale_1.LOCALE_COOKIE_NAME}=uz`);
        console.log(`[Locale Route /uz] Base URL: ${baseUrl}`);
