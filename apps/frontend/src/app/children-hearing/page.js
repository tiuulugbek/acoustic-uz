...
exports.default = ChildrenHearingPage;
...
async function generateMetadata() {
    ...
    const page = await (0, api_server_1.getPageBySlug)('children-hearing', locale);
...
async function ChildrenHearingPage() {
    const locale = (0, locale_server_1.detectLocale)();
    const [page, categories, branches, settings] = await Promise.all([
        (0, api_server_1.getPageBySlug)('children-hearing', locale),
        (0, api_server_1.getPostCategories)(locale, 'children'),
