...
exports.useAudioTest = useAudioTest;
 ...
 */
const getFrequencyGain = (frequency) => {
    ...
    if (frequency <= 250)
        return 1.8; // Bass frequencies need more gain
    if (frequency <= 500)
        return 1.4;
    if (frequency <= 1000)
...
function useAudioTest() {
    ...
    const [currentFrequency, setCurrentFrequency] = (0, react_1.useState)(null);
    const audioContextRef = (0, react_1.useRef)(null);
    const oscillatorRef = (0, react_1.useRef)(null);
    const gainNodeRef = (0, react_1.useRef)(null);
    const masterGainRef = (0, react_1.useRef)(null);
    const volumeUpdateTimeoutRef = (0, react_1.useRef)(null);
    // Initialize AudioContext with optimal settings
    const initAudioContext = (0, react_1.useCallback)(() => {
    ...
    const stopTone = (0, react_1.useCallback)(() => {
        try {
    ...
    const playTone = (0, react_1.useCallback)(({ frequency, volume, duration, onEnd }) => {
        try {
        ...
        try {
            if (gainNodeRef.current && isPlaying && currentFrequency !== null) {
                ...
                volumeUpdateTimeoutRef.current = setTimeout(() => {
                    ...
                    gainNodeRef.current.gain.linearRampToValueAtTime(finalVolume, audioContext.currentTime + fadeTime);
...
//# sourceMappingURL=useAudioTest.js.map