 ...
 */
function translateTooltipContent(content) {
 ...
 */
function translateTooltipsInContent(content) {
 ...
 */
function translateHtmlContent(content) {
    let translated = content;
...
//# sourceMappingURL=translate_uzbek_descriptions.js.map