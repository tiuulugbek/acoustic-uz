  ...
  const services = [
    {
      ...
      excerpt_ru:
        'На первичной консультации детский сурдолог проведет комплексное обследование слуха, выдаст заключение, и при наличии патологии слуха разработает индивидуальную программу реабилитации слуха у ребенка.',
    ...
    },
    {
      ...
      excerpt_ru:
        'На большом экране вы сможете детально увидеть состояние наружного слухового прохода, барабанной перепонки, и в целом особенности строения наружного уха вашего ребенка.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Метод субъективной диагностики слуха, выполняется детям старше 5 лет и позволяет получить полное представление о порогах слуха ребенка.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Диагностика выполняется детям младшего возраста в звукоизолированной кабине с целью понять, насколько тихие звуки может услышать ребенок.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Метод субъективной диагностики слуха, выполняться детям возраста 6-8 мес. и позволяет уточнить пороги слуха на низких и высоких частотах у детей младшего возраста.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Быстрый и безболезненный метод диагностики состояния среднего уха и слуховых труб у детей, подразделяется на младенческую и традиционную тимпанометрию.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Высокоточный объективный метод для выявления расстройств спектра аудиторных нейропатий.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Метод с повышенной точностью и достоверностью позволяет оценивать состояние среднего уха у маленьких детей.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Метод оценки состояния среднего уха, слуховой трубы, работы внутреннего уха, также можно ориентировочно оценить пороги слуха ребенка.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Простой и эффективный клинический тест, который оценивает функциональное состояние евстахиевых труб у ребенка.',
    ...
    },
    {
      ...
      excerpt_uz:
        'Eshitishni obyektiv diagnostika usuli, avtomatik rejimda to\'rt asosiy nutq chastotasida - 500 Гц, 1, 2 va 4 кГц eshitishni sinash imkonini beradi.',
      excerpt_ru:
        'Объективный метод диагностики слуха, позволяющий в авторежиме протестировать слышимость на четырех основных речевых частотах – 500 Гц, 1, 2 и 4 кГц.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Объективный скрининговый метод позволяет оценить функцию слуховой системы ребенка.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Быстрое и безболезненное обследование слуха, позволяет заподозрить снижение слуха с первых дней жизни ребенка.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Регистрация слуховых вызванных потенциалов (КСВП) выполняется во сне и с высокой точностью позволяет определить нарушение слуха у детей.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Для диагностики нарушений слуха у ребенка врач-сурдолог использует широкий набор аудиометрических тестов.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Набор клинических тестов для получения подробной информации о состоянии барабанной полости и перепонки, слуховых косточек и слуховых труб.',
    ...
    },
    {
      ...
      excerpt_ru:
        'Комплекс объективных методов обследования, необходимых для постановки точного и правильного диагноза малышу с нарушением слуха.',
