...
# TypeScript build muammosini hal qilish

set -e

cd /var/www/news.acoustic.uz

echo "🔧 TypeScript build muammosini hal qilish..."
...
# 4. TypeScript kompilyatsiya qilish (verbose)
echo "🔨 TypeScript kompilyatsiya qilish (verbose)..."
npx tsc --project tsconfig.json --listFiles 2>&1 | tee /tmp/tsc-build.log
...
echo "✅ TypeScript build muammosi hal qilindi!"
