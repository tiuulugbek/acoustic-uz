...
echo -e "${BLUE}🔧 Fixing Next.js chunk 404 errors...${NC}"
echo ""
...
# 15. Test static file access
echo -e "${BLUE}📋 Step 15: Testing static file access...${NC}"
...
if [ -n "$CHUNK_FILE" ]; then
    ...
    echo -e "${YELLOW}  ⚠️  No chunk files found to test${NC}"
fi
...
echo "  5. Test static: curl https://acoustic.uz/_next/static/chunks/webpack-*.js"
echo ""
echo -e "${YELLOW}💡 If chunks still fail:${NC}"
echo "  1. Hard refresh browser (Ctrl+Shift+R)"
echo "  2. Check Nginx logs: tail -f /var/log/nginx/acoustic.uz.error.log"
