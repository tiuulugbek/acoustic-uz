...
# Script to fix SSL redirect error by rebuilding frontend with locale API fixes
# This fixes the issue where redirects use 0.0.0.0:3000 instead of the actual domain

set -e

echo "🔧 Fixing SSL redirect error..."
