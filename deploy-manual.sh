...
echo "📋 Step 1: Create directory structure on server"
...
echo ""
echo "📋 Step 2: Copy application files (excluding node_modules)"
echo "Run this command:"
...
echo ""
echo "📋 Step 3: Copy public folder"
echo "Run this command:"
...
echo ""
echo "📋 Step 4: Copy .next static files"
echo "Run this command:"
...
echo ""
echo "📋 Step 5: Install dependencies on server"
echo "Run this command:"
...
echo ""
echo "📋 Step 6: Create .env.production file"
echo "Run this command:"
